await (async function () {
	...
	*/
	...
	var RgbQuant = /*@__PURE__*/getDefaultExportFromCjs(rgbquantExports);
	...
	class Ranges {
	    constructor() {
	        this.ranges = []; // list of ranges, sorted by start
	    }
	    addRange([start, end]) {
	        if (start >= end) {
	...
	const createInstantiatorMap = (create) => {
	    const map = new Map();
	    let obj = {
	        get(key) {
	            if (!map.get(key)) {
